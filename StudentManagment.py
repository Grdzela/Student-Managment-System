...
root = tk.Tk()
root.title("Managment")

connection = sqlite3.connect("managment.db")

TABLE_NAME = "managment_table"
STUDENT_ID = "student_id"
STUDENT_NAME = "student_name"
STUDENT_COLLAGE = "student_college"
STUDENT_ADDRESS = "student_address"
STUDENT_PHONE = "student_phone"

connection.execute("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (" + STUDENT_ID +
                   " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                   STUDENT_NAME + " TEXT, " + STUDENT_COLLAGE + " TEXT, " +
                   STUDENT_ADDRESS + " TEXT, " + STUDENT_PHONE + " INTEGER);")

appLabel = tk.Label(root, text="Student Managment System",
                    fg="#06a099", width=35)
...
class Student:
    ...
    def __init__(self, studentName, collageName, phoneNumer, address):
...
nameLabel = tk.Label(root, text="Enter your name", width=40, anchor='w', font=(
    "Sylfaen", 12)).grid(row=1, column=0, padx=(110, 0), pady=(30, 0))

collegeLabel = tk.Label(root, text="Enter your collage", width=40, anchor='w', font=(
    "Sylfaen", 12)).grid(row=2, column=0, padx=(110, 0), pady=(30, 0))

phoneLabel = tk.Label(root, text="Enter your phone", width=40, anchor='w', font=(
    "Sylfaen", 12)).grid(row=3, column=0, padx=(110, 0), pady=(30, 0))

addresLabel = tk.Label(root, text="Enter your addres", width=40, anchor='w', font=(
    "Sylfaen", 12)).grid(row=4, column=0, padx=(110, 0), pady=(30, 0))
...
def takeNameInput():
    ...
    global list
    global TABLE_NAME, STUDENT_NAME, STUDENT_COLLAGE, STUDENT_ADDRESS, STUDENT_PHONE
...
def destroyRootWindow():
    ...
    secondWindow.title("Diplay results")

    appLabel = tk.Label(secondWindow, text="Student Managment System",
                        fg="#06a099", width=40)
    appLabel.config(font=("Sylfaen", 30))
    appLabel.pack()
...
button = tk.Button(root, text="Take Input", command=lambda: takeNameInpit())
